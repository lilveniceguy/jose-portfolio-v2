          ...
          <template x-for="post in skillPosts(selSkill.slug)" :key="post.id">
            <div class="rounded-lg border border-border bg-card/40 p-4">
              <div class="mb-2 flex items-center justify-between">
                ...
                <span class="font-mono text-[10px] text-muted-foreground" x-text="post.meta._date_start"></span>
              </div>
              <h4 class="text-sm font-semibold text-foreground" x-text="post.meta._position_title || post.meta._degree_title || post.title"></h4>
              <p class="text-xs text-muted-foreground" x-text="post.meta._company_name || post.meta._institution_name || post.meta._issuing_org"></p>
            </div>
          </template>
        </div>
      </div>
